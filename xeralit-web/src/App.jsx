...
const NAV = [
  ...
  {id:"financial", label:"Financial Overview", icon:Banknote, group:"Intelligence"},
  {id:"operational", label:"Operational Report", icon:Activity, group:"Intelligence"},
  {id:"patient", label:"Patient Data", icon:HeartPulse, group:"Intelligence"},
          ...
          <div style={{marginTop:"auto"}}>
            <div className="card" style={{padding:13}}>
              <div style={{display:"flex",alignItems:"center",gap:9}}>
                ...
                <div><div style={{fontSize:12.5,fontWeight:600}}>Aneesh Adithya SR</div><div className="mono" style={{fontSize:9.5,color:"var(--muted)"}}>Chief Executive</div></div>
              </div>
            </div>
          </div>
        </aside>
